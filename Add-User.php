...
<nav style="border: 1px solid black;" class="navbar bg-dark">
  <div class="container-fluid">
    ...
    <ul class="nav">  
      ...
      <li><a style="text-decoration: none; color: white;margin-left: 20px;" href="Add-User.php">Add-User</a></li>
      <li><a style="text-decoration: none; color: white;margin-left: 20px;" href="Service.php">Services</a></li>
      <li class="active"><a style="text-decoration: none; color: white; margin-left: 20px;" href="Signup.php">Profile</a></li>
      <li><a style="text-decoration: none; color: white;margin-left: 20px;" href="Login.php">Logout</a></li>
  </ul>
  </div>
</nav>
	...
	<div class="row">
		<div class="col">
			...
			<div style="border-radius: 10px;" class=" m-auto bg-white">
				<br>
				<div style="font-size: 25px; font-weight: 800; font-family: sans-serif; text-align: center;">Add Coustmer</div>
