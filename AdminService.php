...
<div class="container">
	<div class="row text-center">
			<div class="col-sm-4">
				<br><br>
			<img src="Images/1.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
		...
		<div class="col-sm-4">
			<br><br>
			<img src="Images/2.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
		...
		<div class="col-sm-4">
		<br><br>	
			<img src="Images/3.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
			...
			cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
			proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
			<button class="btn btn-info btn-lg btn-block">Buy Now</button>
			</div>
			</div>
			<div class="row text-center">
			<div class="col-sm-4">
				<br><br>
			<img src="Images/4.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
		...
		<div class="col-sm-4">
			<br><br>
			<img src="Images/5.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
		...
		<div class="col-sm-4">
		<br><br>	
			<img src="Images/6.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
			...
			<div class="col-sm-4">
				<br><br>
			<img src="Images/7.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
		...
		<div class="col-sm-4">
			<br><br>
			<img src="Images/8.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
		...
		<div class="col-sm-4">
		<br><br>	
			<img src="Images/9.png" width="90%" height="200px">
			<br><br>
			<p class="col-sm-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
